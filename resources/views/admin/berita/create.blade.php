            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200">
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Tambah Berita Baru</h3>
                        <p class="text-gray-600">Lengkapi informasi berita untuk menambahkan ke sistem</p>
                    ...
                    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" id="formTambahBerita"
                        class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-500">Maksimal ukuran foto 2MB.</p>
                            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            <strong>Catatan:</strong> Pastikan semua data yang dimasukkan sudah benar dan foto memiliki format yang didukung (JPG, PNG) dengan ukuran maksimal 2MB.
                        </p>
                    </div>
                </div>
            </div>
