    ...
    <div class="py-12">
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200">
          <div class="p-8">
            <h3 class="text-2xl font-bold text-gray-900 mb-4 text-center">Form Edit Galeri</h3>
            ...
            <form action="{{ route('admin.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
              ...
              <div>
                ...
                placeholder="Masukkan judul galeri"  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl">
              </div>
  
              <div>
                <label for="kategori" class="block text-sm font-semibold text-gray-700 mb-2">Kategori</label>
                <input type="text" name="kategori" id="kategori" value="{{ old('kategori', $galeri->kategori) }}" required
                placeholder="Contoh: Kegiatan, Fasilitas, Prestasi"  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl">
              </div>
              ...
              <div>
                ...
                @if ($galeri->foto)
                  <div class="mb-3">
                    <img src="{{ asset('storage/' . $galeri->foto) }}" class="w-32 h-32 object-cover rounded shadow">
                ...
                old="{{ old('gambar') }}">
                <p class="text-sm text-gray-500 mt-1">Kosongkan jika tidak ingin mengganti. Maks. 2MB.</p>
              </div>
